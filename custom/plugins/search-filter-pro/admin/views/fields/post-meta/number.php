				...
				<p>
					...
					<label for="{0}[{1}][number_decimal_places]">
						<input class="number_decimal_places" id="{0}[{1}][number_decimal_places]" name="{0}[{1}][number_decimal_places]" type="text" size="7" value="<?php echo $values['number_decimal_places']; ?>"> <?php _e("Decimal Places - this is used internally to perform accurate database queries", $this->plugin_slug); ?></label>
					</label>
				</p>
				<div class="clear"></div>
				<hr />
				...
				<fieldset class="item-container child-columns-w">
					...
					<p class="">
						<label for="{0}[{1}][number_values_seperator]">
							...
							<input class="" id="{0}[{1}][number_values_seperator]" name="{0}[{1}][number_values_seperator]" type="text" size="7" value="<?php echo $values['number_values_seperator']; ?>">
						</label>
					</p>
				</fieldset>
				...
				<fieldset class="item-container child-columns-w sf_number_formatting">
					<p class="">
						<label for="{0}[{1}][decimal_places]">
							...
							<input class="" id="{0}[{1}][decimal_places]" name="{0}[{1}][decimal_places]" type="text" size="7" value="<?php echo $values['decimal_places']; ?>">
						</label>
					</p>
					<p class="">
						<label for="{0}[{1}][thousand_seperator]">
							<?php _e("Thousands Seperator", $this->plugin_slug); ?>
							<input class="" id="{0}[{1}][thousand_seperator]" name="{0}[{1}][thousand_seperator]" type="text" size="7" value="<?php echo $values['thousand_seperator']; ?>">
						</label>
					</p>
				</fieldset>
